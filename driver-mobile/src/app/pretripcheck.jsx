...
export default function PreTripCheck() {
  ...
  const ticket = {
    ticketNo: "TT-2026-0001",
    date: "03/30/2026",
    driver: "Justine Montefalco",
    helper: "N/A",
    truck: "FUSO FJ 2828R",
    plate: "XYZ 1213",
    trailer: "N/A",
    client: "Electronics Cargo",
    cargo: "Electronics",
    origin: "Port Area",
    destination: "Malaybalay",
    fuelIssued: "100 L",
    fuelReceipt: "FR-2026-0001",
    remarks: "Handle cargo with care.",
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.card}>
          ...
          <InfoRow label="Helper/Crew" value={ticket.helper} />
          <InfoRow label="Truck No." value={ticket.truck} />
          <InfoRow label="Plate No." value={ticket.plate} />
          <InfoRow label="Trailer No." value={ticket.trailer} />
