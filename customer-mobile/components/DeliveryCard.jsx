...
const STATUS_CONFIG = {
  ...
  dispatched: { label: "Dispatched", color: "#A64DE8", progress: 0 },
  accepted: { label: "OTW to Pickup", color: "#4B88E8", progress: 1 },
  arrived_pickup: { label: "Arrived at Pickup", color: "#4B88E8", progress: 2 },
  out_for_delivery: { label: "In Transit", color: "#4B88E8", progress: 2 },
  arrived_dropoff: { label: "Arrived at Drop-off", color: "#4B88E8", progress: 3 },
  returning_to_hq: { label: "Returning to HQ", color: "#4B88E8", progress: 3 },
  delivered: { label: "Delivered", color: "#45B84A", progress: 4 },
  rejected: { label: "Rejected", color: "#C62828", progress: 0 },
};
      ...
      <View style={styles.driverSection}>
        ...
        <View style={styles.vehicleInfo}>
          <Text style={styles.vehicle}>
            {assigned
              ? delivery.vehicle || "Assigned Vehicle"
              : "To be Assigned"}
          </Text>
